...
Automatically deletes all data except the user id and is
...
**Description:** By passing in the appropriate options, you can search for a specific user or group of users. O
...
| Code | Description |
| ---- | ----------- |
| 200 | Array of search results matching criteria, returns empty if none found |
| 400 | Bad Request |
| 500 | Server error |
...
| Name | Located in | Description | Required | Schema |
| ---- | ---------- | ----------- | -------- | ---- |
| userId | query | The id of the user who is a member of the wallets | Yes | string |
...
| Name | Located in | Description | Required | Schema |
| ---- | ---------- | ----------- | -------- | ---- |
| userId | query | The ID of the User who created this wallet | Yes | integer |
...
| skip | query | number of records to skip for pagination | No | integer |
...
| Name | Located in | Description | Required | Schema |
| ---- | ---------- | ----------- | -------- | ---- |
| walletMemberId | path | The wallet debt id of the payment to be updated | Yes | integer |
